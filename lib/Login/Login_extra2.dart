                ...
                onPressed: () async {
                  ...
                  if (controller.checkPhotographer.value == 0) {
                    ...
                    await firestore.collection('userInfo').doc(uid).set({
                      ...
                      'phoneNumber': controller.instagramID.value,
                      'categoryName':
...
(시행일) 본 약관은 2018년 8월 1일부터 시행됩니다. 개정된 약관의 적용일자 이전 이용자 또는 회원은 개정된 이용약관의 적용을 받습니다.
    ...
    return showModalBottomSheet(
        ...
        builder: (BuildContext context) {
          return Container(
            height: sizeController.screenHeight.value * 0.8,
            width: sizeController.screenWidth.value,
            padding: const EdgeInsets.all(16.0),
            decoration: const BoxDecoration(
              color: AppColor.backgroundColor, // 배경 색상
                  ...
                  Expanded(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        border: Border.all(
                          color: AppColor.objectColor, // 테두리 색상 지정
                          width: 2.0, // 테두리 두께 지정
                        ),
                      ),
                      child: Padding(
